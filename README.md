## Estudos para testes automatizados

#### Tem um arquivo interessante de fundamentos teóricos. a api pokemom está em um arquivo zipado, basta descompactar e rodar npm i, depois npm run dev
